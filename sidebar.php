...
<body ng-app="login_register_app" ng-controller="login_register_controller">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            ...
            <span style="color:black;">  Naija<br>Opinion</span>
            </a>
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a  href="index.php" aria-expanded="false">
                       ...
                       <li><a  href="../buy-coupon.php" aria-expanded="false">
							<i class="fa fa-briefcase"></i>
							<span class="nav-text">Buy Coupon</span>
						</a>
                      
                    </li>

                       <li><a  href="../check_coupon.php" aria-expanded="false">
							<i class="fa fa-search"></i>
							<span class="nav-text">Check Coupon Code</span>
						</a>
                          ...
                          <li><a  href="../Faq.php" aria-expanded="false">
                           ...
                           <li><a  href="https://t.me/joinchat/Xq-LOuv1y21lNzU0" aria-expanded="false">
							<i class="fa fa-telegram"></i>
							<span class="nav-text">Telegram Group</span>
						</a>
