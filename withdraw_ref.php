...
while($row=mysqli_fetch_assoc($q)){
 ...
 $user_id= $_SESSION['ID'];
		...
		//$all_unpaid_number=mysqli_num_rows($q);
			while($row=mysqli_fetch_assoc($q)){
				$original_ref = $row['amount'];
				$unpaid_amount=$row['amount'] / 1000;
		...
		<center>
<a href="index.php"><button class="btn btn-primary"><<</button></a><button class="btn btn-primary" style="background-color:btn btn-primary;"><h6 style="color: white;">withdrawal is in multiple of 1000</h6></button>
<br>
...
<input type="text" name="referral" class="form-control" style="background-color:white; width:70%;" value="<?php echo floor($unpaid_amount).'000';?>" readonly><br>
...
<input type="tel" name="media" class="form-control" style="background-color:white; width:70%;" value="" required><br>
<input type="hidden" name="original_ref" class="form-control" style="background-color:white; width:70%;" value="<?php echo $original_ref; ?>" ><br>
<label>Bank Name</label>
               <select class="form-control" name='bank' style='color:black; background-color:white; width:70%;' required>
